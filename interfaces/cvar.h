...
public:
	void register_con_command(sdk::con_command_base *command_base) {
		return utils::memory::call_virtual<void>(offsets::register_con_command, this, command_base);
	}
	void unregister_con_command(sdk::con_command_base *command_base) {
		return utils::memory::call_virtual<void>(offsets::unregister_con_command, this, command_base);
	}
