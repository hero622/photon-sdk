...
public:
	...
	virtual void checkbox( bool &val, const char *label );                                                 //	Checkbox using boolean value.
	...
	virtual void combo( std::size_t &val, const char *items[], int items_count, const char *label );       //	Value is the index of the selected element.
	virtual void multicombo( std::size_t &val, const char *items[], int items_count, const char *label );  //	Value is a bitmask containing selected elements.
};
